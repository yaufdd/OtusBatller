...
public class GameController : MonoBehaviour
{
    ...
    [SerializeField] private CanvasGroup victoryMessage;
    [SerializeField] private CanvasGroup defeatMessage;
    ...
    private void Start()
    {
        ...
        OffCanvas(victoryMessage, defeatMessage);
    ...
    private void GameOver()
    {
        ...
        if (isVictory)
        {
            OnCanvas(victoryMessage);
        }
        else
        {
            OnCanvas(defeatMessage);
        }
    }
    ...
    private void OffCanvas(CanvasGroup winCanvas, CanvasGroup loseCanvas)
    {
        winCanvas.alpha = 0;
        loseCanvas.alpha = 0;
    ...
    private void OnCanvas(CanvasGroup currentCanvas)
    {
